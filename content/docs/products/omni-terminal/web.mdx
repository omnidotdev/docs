...
The [Android app](/products/omni-terminal/android) can connect to a self-hosted web server as a remote terminal client. Enter the server URL (e.g. `wss://192.168.1.100:3000/ws`) on the Android home screen and tap **Connect**.

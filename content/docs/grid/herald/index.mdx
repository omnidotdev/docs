...
2. **Through [Vortex](/grid/vortex)** workflows, which render an email and hand it to Herald, falling back to a third-party provider on failure.
...
Herald is an internal platform service. See [Architecture](/docs/grid/herald/architecture)

...
See [API keys](/docs/grid/herald/api-keys) for expiry and rotation.
...
**Verify**. See [Sending domains](/docs/grid/herald/domains).
...
[webhooks](/docs/grid/herald/webhooks). Hard bounces and complaints add the
...
- [The TypeScript SDK and MCP server](/docs/grid/herald/sdk)

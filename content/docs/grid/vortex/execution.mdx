...
Vortex workflows are executed by the **vortex-worker** service. The API dispatches each run to one of three pluggable backends (Hatchet, Temporal, or Local), then the worker processes the DSL step-by-step.

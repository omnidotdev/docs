...
Synapse can be self-hosted from source, via Docker, or with prebuilt binaries. See the [Self-Hosting guide](/grid/synapse/self-hosting) for installation options.

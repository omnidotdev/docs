...
Synapse can be self-hosted from source, via Docker, or with prebuilt binaries. See the [Self-Hosting guide](/help/self-hosting#synapse) for installation options.
